...
The web app ([example-web-app-deployment.yaml](../../kubernetes/manifests/example-web-app-deployment.yaml)) uses an HTTP `livenessProbe` on `/healthz` (process is up) and
